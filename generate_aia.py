...
screen2_bky = """<xml xmlns="http://www.w3.org/1999/xhtml">
  ...
  <block type="component_event" id="b_temp_click" x="30" y="330">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonTemperatura" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonTemperatura</field>
    <statement name="DO">
      <block type="controls_openAnotherScreen" id="b_open_screen6">
        <value name="SCREEN">
          <block type="text" id="b_scr6_title">
  ...
  <block type="component_event" id="b_sair_click" x="30" y="430">
...
# --- Screen 6: CONVERSOR DE TEMPERATURAS ---
screen6_components = [
    {
        "$Name": "LabelTituloTemperatura",
        "$Type": "Label",
        "Text": "CONVERSOR DE TEMPERATURAS",
        "FontSize": "24",
        "FontBold": "True",
    ...
    {
        "$Name": "LabelValorTemperatura",
        "$Type": "Label",
        "Text": "Temperatura",
        "FontSize": "16"
    },
    {
        "$Name": "TextBoxTemperatura",
        "$Type": "TextBox",
        "Hint": "Digite a temperatura",
        "NumbersOnly": "True",
        "Width": "-2"
    },
    {
        "$Name": "LabelConversaoTemperatura",
        "$Type": "Label",
        "Text": "Escolha a conversão",
        "FontSize": "16"
    },
    {
        "$Name": "ButtonCelsiusFahrenheit",
        "$Type": "Button",
    ...
    {
        "$Name": "LabelResultadoTemperatura",
        "$Type": "Label",
        "Text": "Resultado:",
        "FontSize": "18",
        "FontBold": "True"
    ...
    {
        "$Name": "LabelInfoFormula",
        "$Type": "Label",
        "Text": "Conversões realizadas com fórmulas matemáticas. Não utiliza internet ou API.",
        "FontSize": "12",
        "TextAlignment": "1"
    }
]

screen6_bky = """<xml xmlns="http://www.w3.org/1999/xhtml">
  <!-- CELSIUS -> FAHRENHEIT: F = (C * 9 / 5) + 32 -->
  <block type="component_event" id="b_c_to_f_click" x="30" y="30">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonCelsiusFahrenheit" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonCelsiusFahrenheit</field>
    <statement name="DO">
      <block type="controls_if" id="b_if_empty_cf">
        <mutation else="1"></mutation>
        <value name="IF0">
          <block type="text_isEmpty" id="b_chk_empty_cf">
            <value name="VALUE">
              <block type="component_set_get" id="b_get_val_cf">
                <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                <field name="PROP">Text</field>
              </block>
            </value>
          </block>
        ...
        <statement name="DO0">
          <block type="component_set_get" id="b_set_empty_cf">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text" id="b_msg_empty_cf">
                <field name="TEXT">Digite um valor para temperatura</field>
              </block>
            </value>
          </block>
        </statement>
        <statement name="ELSE">
          <block type="component_set_get" id="b_set_res_cf">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text_join" id="b_join_cf">
                <mutation items="3"></mutation>
                <value name="ADD0">
                  <block type="text" id="b_prefix_cf">
                    <field name="TEXT">Resultado: </field>
                  </block>
                </value>
                <value name="ADD1">
                  <block type="math_format_as_decimal" id="b_fmt_cf">
                    <value name="NUM">
                      <block type="math_add" id="b_calc_cf">
                        <value name="NUM0">
                          <block type="math_division" id="b_div_cf">
                            <value name="A">
                              <block type="math_multiply" id="b_mul_cf">
                                <value name="NUM0">
                                  <block type="component_set_get" id="b_get_temp_cf">
                                    <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                                    <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                                    <field name="PROP">Text</field>
                                  </block>
                                ...
                                <value name="NUM1">
                                  <block type="math_number" id="b_num_9">
                            ...
                            <value name="B">
                              <block type="math_number" id="b_num_5">
                        ...
                        <value name="NUM1">
                          <block type="math_number" id="b_num_32">
                    ...
                    <value name="PLACES">
                      <block type="math_number" id="b_num_2_cf">
                        <field name="NUM">2</field>
                      </block>
                    </value>
                  </block>
  ...
  <block type="component_event" id="b_f_to_c_click" x="30" y="250">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonFahrenheitCelsius" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonFahrenheitCelsius</field>
    <statement name="DO">
      <block type="controls_if" id="b_if_empty_fc">
        <mutation else="1"></mutation>
        <value name="IF0">
          <block type="text_isEmpty" id="b_chk_empty_fc">
            <value name="VALUE">
              <block type="component_set_get" id="b_get_val_fc">
                <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                <field name="PROP">Text</field>
              </block>
        ...
        <statement name="DO0">
          <block type="component_set_get" id="b_set_empty_fc">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text" id="b_msg_empty_fc">
                <field name="TEXT">Digite um valor para temperatura</field>
              </block>
            </value>
          </block>
        ...
        <statement name="ELSE">
          <block type="component_set_get" id="b_set_res_fc">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text_join" id="b_join_fc">
                <mutation items="3"></mutation>
                <value name="ADD0">
                  <block type="text" id="b_prefix_fc">
                    <field name="TEXT">Resultado: </field>
                  </block>
                </value>
                <value name="ADD1">
                  <block type="math_format_as_decimal" id="b_fmt_fc">
                    <value name="NUM">
                      <block type="math_division" id="b_div_fc">
                        <value name="A">
                          <block type="math_multiply" id="b_mul_fc">
                            <value name="NUM0">
                              <block type="math_subtract" id="b_sub_fc">
                                <value name="A">
                                  <block type="component_set_get" id="b_get_temp_fc">
                                    <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                                    <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                                    <field name="PROP">Text</field>
                                  </block>
                                ...
                                <value name="B">
                                  <block type="math_number" id="b_num_32_fc">
                                    <field name="NUM">32</field>
                                  </block>
                                </value>
                              </block>
                            ...
                            <value name="NUM1">
                              <block type="math_number" id="b_num_5_fc">
                                <field name="NUM">5</field>
                              </block>
                            </value>
                          </block>
                        ...
                        <value name="B">
                          <block type="math_number" id="b_num_9_fc">
                            <field name="NUM">9</field>
                          </block>
                        </value>
                      </block>
                    ...
                    <value name="PLACES">
                      <block type="math_number" id="b_num_2_fc">
                        <field name="NUM">2</field>
                      </block>
                    </value>
                  </block>
  ...
  <block type="component_event" id="b_c_to_k_click" x="30" y="470">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonCelsiusKelvin" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonCelsiusKelvin</field>
    <statement name="DO">
      <block type="controls_if" id="b_if_empty_ck">
        <mutation else="1"></mutation>
        <value name="IF0">
          <block type="text_isEmpty" id="b_chk_empty_ck">
            <value name="VALUE">
              <block type="component_set_get" id="b_get_val_ck">
                <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                <field name="PROP">Text</field>
              </block>
        ...
        <statement name="DO0">
          <block type="component_set_get" id="b_set_empty_ck">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text" id="b_msg_empty_ck">
                <field name="TEXT">Digite um valor para temperatura</field>
              </block>
            </value>
          </block>
        ...
        <statement name="ELSE">
          <block type="component_set_get" id="b_set_res_ck">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text_join" id="b_join_ck">
                <mutation items="3"></mutation>
                <value name="ADD0">
                  <block type="text" id="b_prefix_ck">
                    <field name="TEXT">Resultado: </field>
                  </block>
                </value>
                <value name="ADD1">
                  <block type="math_format_as_decimal" id="b_fmt_ck">
                    <value name="NUM">
                      <block type="math_add" id="b_add_ck">
                        <value name="NUM0">
                          <block type="component_set_get" id="b_get_temp_ck">
                            <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                            <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                            <field name="PROP">Text</field>
                          </block>
                        ...
                        <value name="NUM1">
                          <block type="math_number" id="b_num_273_15">
                    ...
                    <value name="PLACES">
                      <block type="math_number" id="b_num_2_ck">
                        <field name="NUM">2</field>
                      </block>
                    </value>
                  </block>
  ...
  <block type="component_event" id="b_k_to_c_click" x="30" y="670">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonKelvinCelsius" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonKelvinCelsius</field>
    <statement name="DO">
      <block type="controls_if" id="b_if_empty_kc">
        <mutation else="1"></mutation>
        <value name="IF0">
          <block type="text_isEmpty" id="b_chk_empty_kc">
            <value name="VALUE">
              <block type="component_set_get" id="b_get_val_kc">
                <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                <field name="PROP">Text</field>
              </block>
        ...
        <statement name="DO0">
          <block type="component_set_get" id="b_set_empty_kc">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text" id="b_msg_empty_kc">
                <field name="TEXT">Digite um valor para temperatura</field>
              </block>
            </value>
          </block>
        ...
        <statement name="ELSE">
          <block type="component_set_get" id="b_set_res_kc">
            <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
            <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
            <field name="PROP">Text</field>
            <value name="VALUE">
              <block type="text_join" id="b_join_kc">
                <mutation items="3"></mutation>
                <value name="ADD0">
                  <block type="text" id="b_prefix_kc">
                    <field name="TEXT">Resultado: </field>
                  </block>
                </value>
                <value name="ADD1">
                  <block type="math_format_as_decimal" id="b_fmt_kc">
                    <value name="NUM">
                      <block type="math_subtract" id="b_sub_kc">
                        <value name="A">
                          <block type="component_set_get" id="b_get_temp_kc">
                            <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="get"></mutation>
                            <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
                            <field name="PROP">Text</field>
                          </block>
                        ...
                        <value name="B">
                          <block type="math_number" id="b_num_273_15_kc">
                            <field name="NUM">273.15</field>
                          </block>
                        </value>
                      </block>
                    ...
                    <value name="PLACES">
                      <block type="math_number" id="b_num_2_kc">
                        <field name="NUM">2</field>
                      </block>
                    </value>
                  </block>
  ...
  <!-- LIMPAR -->
  <block type="component_event" id="b_limpar_click" x="30" y="870">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonLimparTemperatura" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonLimparTemperatura</field>
    <statement name="DO">
      <block type="component_set_get" id="b_set_clear_tb">
        <mutation component_type="TextBox" instance_name="TextBoxTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
        <field name="COMPONENT_SELECTOR">TextBoxTemperatura</field>
        <field name="PROP">Text</field>
        <value name="VALUE">
          <block type="text" id="b_txt_empty_tb">
            <field name="TEXT"></field>
          </block>
        </value>
      </block>
      <block type="component_set_get" id="b_set_clear_res">
        <mutation component_type="Label" instance_name="LabelResultadoTemperatura" property_name="Text" is_generic="false" get_or_set="set"></mutation>
        <field name="COMPONENT_SELECTOR">LabelResultadoTemperatura</field>
        <field name="PROP">Text</field>
        <value name="VALUE">
          <block type="text" id="b_txt_init_res">
            <field name="TEXT">Resultado:</field>
          </block>
        </value>
      </block>
  ...
  <!-- VOLTAR -->
  <block type="component_event" id="b_voltar_temp_click" x="30" y="1020">
    <mutation component_type="Button" is_generic="false" instance_name="ButtonVoltarTemperatura" event_name="Click"></mutation>
    <field name="COMPONENT_SELECTOR">ButtonVoltarTemperatura</field>
    <statement name="DO">
      <block type="controls_closeScreen" id="b_close_temp"></block>
    </statement>
  </block>
</xml>"""
...
def build_aia():
    ...
    screens = [
        ...
        ("Screen6", "CONVERSOR DE TEMPERATURAS", screen6_components, screen6_bky),
    ]
